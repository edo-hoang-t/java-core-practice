...
public class ListPerformanceEvaluation {
    ...
    private static void add1MElements(List<Integer> list, int elem) {
    ...
    public static void main(String[] args) {
        ...
        // a)
        add1MElements(arrayList, -1);
        // b)
        add1MElements(linkedList, -1);
        ...
        add1MElements(arrayList, 1_000_000);
        ...
        add1MElements(linkedList, 1_000_000);
        mill = System.nanoTime();
